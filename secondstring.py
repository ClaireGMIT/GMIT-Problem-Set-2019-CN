...
# 1. At current stage can enter a sentnece and return all characters in sentence from between position 1 and 9 using "print (s[1:9])". I'm going to try and see if i can separate via spaces and then choose every second word. 
